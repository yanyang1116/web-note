...
export type SyncReducerCollection = XOR<{}, Record<StateKeyCollection, typeof syncReducer>>
export type AsyncActionCollection = Exclude<keyof typeof actionCollection, 'sync'>

export type SyncActionFn = (key: StateKeyCollection, payload: any) => void
export type AsyncActionFn = (actionKey: AsyncActionCollection, params?: any) => Promise<any>
export type MapDispatchToPropsReturn = {
	syncAction: SyncActionFn
	asyncAction: AsyncActionFn
}
export type DispatchFn = (dispatch: Dispatch, getState: () => void) => Promise<any>
export type Dispatch = (action: XOR<SyncAction<any>, DispatchFn>) => XOR<void, Promise<any>>
